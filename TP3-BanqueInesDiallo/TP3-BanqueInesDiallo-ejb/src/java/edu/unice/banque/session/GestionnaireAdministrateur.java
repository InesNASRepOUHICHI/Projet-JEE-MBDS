...
public class GestionnaireAdministrateur {
    ...
    public void creerAministrateur() {
        ...
        em.persist(new Administrateur("Diallo", "Hasso", "04432316", "Arenas", sexe[rand], "hasso@gmail.com", "diallo", Role.ADMIN));
        em.persist(new Administrateur("Perez", "Mari", "04438314", "Thier", sexe[rand], "perez@gmail.com", "perez", Role.ADMIN));
        em.persist(new Administrateur("Ezaher", "Fatima", "04432399", "Moulin", sexe[rand], "fatima@gmail.com", "fatima", Role.ADMIN));
        em.persist(new Administrateur("Lelaidier", "Patrick", "04532314", "Liberatin", sexe[rand], "patrick@gmail.com", "patrick", Role.ADMIN));
